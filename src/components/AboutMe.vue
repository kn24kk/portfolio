<template>
  <div id="aboutme" class="aboutme">
    ...
    <div class="container">
      <table class="list">
        <tr v-for="item in profile" class="item">
  ...
  data() {
    return {
      profile: [
        ...
        {title:'実務経験があるもの',data:'企業ページ, LPページ, バナー, メールマガジン, 小規模なWebサイトのディレクション, CMS（MovableType）の組み込み、クライアント向けCMS作業手順マニュアル作成'},
...
.aboutme {
  padding: 4em 0;
  background: darken($color: $l-gray, $amount: 5);
  background: linear-gradient(45deg, $l-gray, darken($l-gray,10));
}
.container {
  margin: 0 8vw;
}
